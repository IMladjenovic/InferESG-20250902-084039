...
@agent(
    name="ReportAgent",
    description=(
        "This agent generates ESG reports about sustainability documents uploaded by users, "
        "analyzing environmental, social, and governance aspects to identify potential greenwashing"
    ),
    tools=[],
)
class ReportAgent(Agent):
    async def invoke(self, utterance: str) -> str:
        ...
        Args:
            utterance: The content of the sustainability document to analyze
